...
bool init_conditions(char station_id[restrict static 1],
  ...
  cJSON* properties_json =
	...
	// Elevation
	cJSON* elevation_json = cJSON_GetObjectItemCaseSensitive(properties_json, "elevation");
  ...
  cJSON* max_temp_24_json =
      cJSON_GetObjectItemCaseSensitive(properties_json, "maxTemperatureLast24Hours");
  ...
  cJSON* min_temp_24_json =
      cJSON_GetObjectItemCaseSensitive(properties_json, "minTemperatureLast24Hours");
  ...
  cJSON* precip_hour_json =
      cJSON_GetObjectItemCaseSensitive(properties_json, "precipitationLastHour");
  ...
  cJSON* precip_3hour_json =
      cJSON_GetObjectItemCaseSensitive(properties_json, "precipitationLast3Hours");
  ...
  cJSON* precip_6hour_json =
      cJSON_GetObjectItemCaseSensitive(properties_json, "precipitationLast6Hours");
